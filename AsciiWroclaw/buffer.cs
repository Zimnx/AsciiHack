...
namespace AsciiWroclaw
{
    ...
    class buffer
    {
        ...
        static private SafeFileHandle h;
        static private CharInfo[] buf;
        static private SmallRect rect;
        ...
        static public void Draw(String str, int Width, int Height, short attribute) //Draws the image to the buffer
        {
        ...
        /// </summary>
        static public void Print() //Paint the image
        {
            if (!h.IsInvalid)
            {
        ...
        /// </summary>
        /// <param name="b"></param>
        static public void setBuf(CharInfo[] b)
        {
            if (b == null)
            {
        ...
        /// <param name="x"></param>
        /// <param name="y"></param>
        static public void setDrawCord(short x, short y)
        {
        ...
        static public void clearRow(int row)
        {
        ...
        static public void clearColumn(int col)
        {
        ...
        /// byte attribute
        /// </returns>
        static public KeyValuePair<byte, byte> getCharAt(int x, int y)
        {
